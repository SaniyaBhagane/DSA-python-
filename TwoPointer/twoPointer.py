...
#         n = len(chars)
#         i, j = 0, 0 # Step 1: Remove extra spaces
#         while j < n:
...
#                 chars[i] = ' '
#                 i += 1
#         if i > 0 and chars[i - 1] == ' ': # Remove trailing space if exists
#             i -= 1
#         chars = chars[:i]
#         chars.reverse() # Step 2: Reverse the entire string
#         start = 0 # Step 3: Reverse each word
